...
- Step 6 - Creating the "**{{postgresql_mediawiki_database_user}}**" user for the Primary PostgreSQL
...
- Step 7 - Creating the "**{{postgresql_mediawiki_database_replication_user}}**" user for the Primary PostgreSQL
...
- Step 6 - Deleting all contents inside the PostgreSQL Replication directory - ``{{postgresql_database_vhdd_2_disk_dir}}/postgresql/14/main``       
...
- Step 8 - Starting pg_basebackup for replication
        ...
        -U {{postgresql_mediawiki_database_replication_user}} \
        -P -v -R
